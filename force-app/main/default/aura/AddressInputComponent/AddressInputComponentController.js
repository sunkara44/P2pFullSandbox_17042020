({
    ...
    getAddressDetails : function(component,event, helper){
        ...
        if(flagupdate == true)
       component.set('v.checkvalidaddress', true);
    },
    ...
    validateAddressFields : function(component, event, helper) {
        ...
        var checkvalidaddress = component.get('v.checkvalidaddress');
        ...
        if(component.get("v.isInternationalAddress")) {
            ...
            if(component.get("v.renderAddressInput")) {
                ...
                else if(searchStr!=null && checkvalidaddress == false){
                    console.log('Address component entered');
                    component.set("v.manualaddress",true);
                    console.log(component.get("v.manualaddress"));
                    
                    
                    //var action=component.get("v.passAddress");
                    //console.log(action);
                    //$A.enqueueAction(action);
                   // $A.enqueueAction(vx); 
                //component.find("autoInput").set("v.errors", [{message:"please use can't find address link to input your address if adddress is not found"}]);    
                  //isValidAddress = false; 
                }
            }
