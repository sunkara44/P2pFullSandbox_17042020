({
    doInit : function (component, event, helper) {     
        console.log('Do in it manualaddress-------->' + component.get("v.manualaddress") );
    ...
    renderNextSection : function(component, event, helper) {
        ...
        console.log('manualaddress---------->'+component.get("v.manualaddress"))
        console.log('Bussiness Name: '+component.get('v.individualBusinessName'));
        if(helper.performBlankInputCheck(component, event)) {
             console.log('display');
            document.querySelector("#formPartB #generalErrorMsgDiv").style.display = 'block';
            document.querySelector("#formPartB #generalErrorMsgDiv").scrollIntoView();
            document.querySelector("#formPartB #generalErrorMsgDiv2").style.display = 'block';
            document.querySelector("#formPartB #generalErrorMsgDiv2").scrollIntoView();
            return;
        }
        else {
            console.log('none');
            document.querySelector("#formPartB #generalErrorMsgDiv").style.display = 'none';
            document.querySelector("#formPartB #generalErrorMsgDiv2").style.display = 'none';
