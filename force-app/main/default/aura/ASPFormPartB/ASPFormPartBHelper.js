({
    ...
    saveSectionData : function(component, event, finishLater, reviewSave) {
        ...
        */
        ...
        if(component.find("Residential-Address-Input").get("v.isInternationalAddress") == false) {
            ...
            console.log('Residential adr testing');
             console.log(component.get('v.searchString'));
           // console.log(component.get('v.residentialCity').toUpperCase());
           // console.log(component.get('v.residentialState'));
            //console.log(component.get('v.residentialPostcode'));
            //console.log(component.get('v.residentialStreet'));
 ...
 if(component.get("v.checkvalidaddress") == false && component.get("v.checkrenderAddressInput") == false){
            console.log('loop 1');
         console.log(component.get('v.manualaddress'));
          console.log('Sree6' + component.find("Residential-Address-Input").get("v.manualaddress"))
            if(component.get("v.manualaddress") == true){
                console.log('sree4');
                hasRequiredInputsMissing = true;  
            ...
            /*
            if(
                (component.get('v.residentialState')=== null || component.get('v.residentialState')==="" || component.get('v.residentialState')==undefined) 
                || (component.get('v.residentialPostcode')===null || component.get('v.residentialPostcode')==="" || component.get('v.residentialPostcode')== undefined) 
                || (component.get('v.residentialStreet')===null || component.get('v.residentialStreet')==="" || component.get('v.residentialStreet')== undefined)
            )
            {   
                console.log('sree4');
                hasRequiredInputsMissing = true;
        ...
        console.log('hasRequiredInputsMissingvalue' + hasRequiredInputsMissing)
