({
    ...
    saveSectionData : function(component, event, finishLater, reviewSave) {
        console.log('Street' + component.find("Applicant-Residential-Address-Input").get("v.street"));
        console.log('State' + component.find("Applicant-Residential-Address-Input").get("v.state"));
        console.log('City' + component.find("Applicant-Residential-Address-Input").get("v.city"));
        console.log('Postcode' + component.find("Applicant-Residential-Address-Input").get("v.postalcode"));
        ...
        for(var index = 0; index < applicantContacts.length; index++) {
            ...
            */
            //component.find("Applicant-Residential-Address-Input").get("v.fullStreet");
            //
            //applicantContacts[index]["Residential_Address_Street__c"] = applicantContacts[index]["residentialStreet"];
            applicantContacts[index]["Residential_Address_Street__c"] = component.find("Applicant-Residential-Address-Input").get("v.fullStreet");
            //applicantContacts[index]["Residential_Address_City__c"] = applicantContacts[index]["Residential_Address_City__c"].toUpperCase();
            applicantContacts[index]["Residential_Address_City__c"]=  component.find("Applicant-Residential-Address-Input").get("v.city").toUpperCase();
    ...
    performBlankInputCheck : function(component, event) {
        ...
        var hasRequiredInputsMissing = false;
         console.log(component.get("v.checkvalidaddress"));
        var applicantContacts2 = component.get('v.aspApplicants');
         if(component.get("v.checkvalidaddress") == false && component.get("v.checkrenderAddressInput") == false){
            console.log('loop 1');
            console.log(component.get('v.aspApplicants').residentialStreet);  
            console.log(component.get('v.aspApplicants').Residential_Address_State__c);
            console.log('applicantContacts2'+ applicantContacts2); 
             if(applicantContacts2===null || applicantContacts2==="" || applicantContacts2==undefined) {
            //if(
               // (component.get('v.applicantResidentialState')=== null || component.get('v.applicantResidentialState')==="" || component.get('v.applicantResidentialState')==undefined) 
                //|| (component.get('v.applicantResidentialPostalCode')===null || component.get('v.applicantResidentialPostalCode')==="" || component.get('v.applicantResidentialPostalCode')== undefined) 
               // || (component.get('v.applicantResidentialStreet')===null || component.get('v.applicantResidentialStreet')==="" || component.get('v.applicantResidentialStreet')== undefined)
           // )
           // {   
                console.log('Part C validation');
