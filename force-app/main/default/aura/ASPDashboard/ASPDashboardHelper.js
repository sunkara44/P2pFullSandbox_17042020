({
    ...
    exportData : function(component, event, type, fileName, dataToExport){
        ...
        if(type == 'Drivers') {
            ...
            if(component.get('v.ShowLicenceEligibility') == false)
             ...
             headerArray.push('PT Code Start Date');
    ...
    renderDriverTable: function(component, newRecordsToAppend) {
        ...
        for(var i=0;i<newRecordsToAppend.length;i++) {
            ...
            rowBody += '<td role="gridcell" style="width:13%;max-width: 114px;word-wrap: break-word;white-space: pre-wrap;">';
            ...
            rowBody += '<td role="gridcell" style="width:5%;max-width:114px;word-wrap: break-word;white-space: pre-wrap;">';
            ...
            rowBody += '<td role="gridcell" style="width:4%;max-width:114px;word-wrap: break-word;white-space: pre-wrap;">';
