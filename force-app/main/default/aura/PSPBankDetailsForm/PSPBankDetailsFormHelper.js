        ...
        if(paymentMethod == "Credit Card/Debit Card" || paymentMethod == "Direct Debit") {
            ...
            updateOrderAction.setCallback(this,function(result) {
                ...
                if(state === "SUCCESS") {
                    ...
                    console.log('applicationType--->'+component.get("v.applicationType"));
                    console.log('paymentReferenceNumber--->'+component.get("v.paymentReferenceNumber"));
                    console.log('isInitiatedFromManageAccount--->'+component.get("v.isInitiatedFromManageAccount"));
                    console.log('sfRecordId--->'+sfRecordId);
